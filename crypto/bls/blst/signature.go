...
// 주어진 공개키, 메시지, 서명을 이용해서 서명 검증을 수행한다.
//
// In IETF draft BLS specification:
// IETF 초안에서 정의된 BLS 서명 검증 알고리즘
// Verify(PK, message, signature) -> VALID or INVALID: a verification
//
//	algorithm that outputs VALID if signature is a valid signature of
//	message under public key PK, and INVALID otherwise.
//
// 이 알고리즘은 서명이 공개키로 생성된 메시지의 유효한 서명인 경우 VALID를 반환하고, 그렇지 않은 경우 INVALID를 반환한다.
//
// In the Ethereum proof of stake specification:
// 이더리움 프로토콜에서 정의된 서명 검증 알고리즘
